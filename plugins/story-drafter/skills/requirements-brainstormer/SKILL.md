---
name: requirements-brainstormer
...
Runs without user interaction, inside the `story-drafter` agent (which owns the clarification cards and the create gate) or standalone.
