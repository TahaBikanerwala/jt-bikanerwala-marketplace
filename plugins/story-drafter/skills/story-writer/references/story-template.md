...
Use `## <heading>` for section titles inside the body (not `#`, so the work-item title stays the visual top heading after conversion).
...
(Adjust the list to the story; keep it a checkbox list.)
