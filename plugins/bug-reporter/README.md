...
| `severity_label_map` | `sev1: ["1 - Critical", ...]` | Abstract tier (resolved against the hardcoded sev1..sev4 evidence table in Phase 3 of `agents/bug-reporter.md`) to the vendor's label. |
