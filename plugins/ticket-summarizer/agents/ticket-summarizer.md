...
| Phase 2 | `executive-blurb-writer` (this plugin) | Turn a fetched `Issue[]` into a concise, one-sentence (rarely two) client-facing blurb per item. |
...
- Bullets are terse: one sentence, rarely two, no filler, no restated ticket metadata.
